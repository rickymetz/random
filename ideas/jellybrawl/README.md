...
| `board.js`, `boards.js` | Board mode: dice, forks, coins and stars, shop and secret items, duels, events; and the three themed maps (Neon City, Slime Sewers, Volcano Isle). |
