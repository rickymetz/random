...
export const TYPES = [
  ...
  },
  {
    ...
    desc: "A sleeping alcove at the window wall — the queen turns sideways for a wall-to-wall fit — behind a pocket-door partition, with bath and wardrobe along the entry hall. Frosted entry glazing; clear operable window wall at the bed.",
    va: "Habitable + wet: the alcove's window wall carries an egress-sized operable section (VRC R310); WC 15in+ centerline with 21in+ in front (VRC ch.27), exhaust through the floor. Interior partition is framing, not steel — no envelope cuts.",
    furniture: [
      { x: -6.2, z: 0, w: 5.2, d: 6.6, h: 2.0, color: 0xd9cfc0 },        // queen rotated 90 — wall-to-wall alcove at the window
      { x: -3.35, z: 1.0, w: 0.35, d: 5.1, h: 8.0, color: 0xe6e1d8 },    // partition (2ft pocket-door opening at the hall)
      { x: -1.9, z: 2.35, w: 1.6, d: 2.4, h: 1.4, color: 0xf2efe8 },     // WC (15in+ to partition and vanity)
      { x: 0.75, z: 2.65, w: 2.6, d: 1.8, h: 3.0, color: 0xdad2c4 },     // vanity
      { x: 3.6, z: 1.95, w: 3.2, d: 3.2, h: 7.0, color: 0xcfd8dc },      // shower
...
export const PLAN_LABELS = {
  ...
  suite: ["bed", "", "WC", "vanity", "shower", "wardrobe"],
